...
const main = async () => {
  ...
  try {
    console.log("Connecting to Neo4j to create index...")
    ...
    console.log("Success: 'term_search' full-text index has been created.")
    console.log("Database is ready for fuzzy search.")
  } finally {
    await session.close()
    await driver.close()
  }
